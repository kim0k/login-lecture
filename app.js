...
// 라우팅
const home = require("./routes/home"); //만들어둔 자바스크립트 파일은 불러온다, 폴더를 명시 해당 폴더에 있는 자바 스크립트 파일을 불러 오는것

// 앱 세팅
app.set("views", ("./views")); // views 세팅, 화면 뷰를 관리해줄 파일이 저장된 views를 두번쨰 파라미터로 지정
